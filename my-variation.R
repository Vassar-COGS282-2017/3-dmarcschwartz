# We added a max similarity value so that agents are satisfied only if
# they are similar to 2/8 or more of their neighbors AND less than
# 6/8 of their neighbors. We also added a third group of agents
# (yellow squares on the plot). If you run the code, you should see
# that segregation levels off at ~ 45%
# model parameters ####
rows <- 50 
cols <- 50
